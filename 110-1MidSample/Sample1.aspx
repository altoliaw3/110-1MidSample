...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <asp:Label runat="server" Text="驗證碼" Font-Size="X-Large"></asp:Label><asp:TextBox ID="tb_Num" runat="server"></asp:TextBox><asp:Image ID="ig_Num" runat="server" /><asp:HiddenField ID="hd_Num" runat="server" /><br />
            <asp:Button ID="btn_Submit" runat="server" Text="送出" PostBackUrl="Sample1Com.aspx" />
        </div>
    </form>
</body>
</html>
